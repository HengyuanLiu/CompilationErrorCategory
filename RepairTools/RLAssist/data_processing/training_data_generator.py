...
def load_dictionaries(destination):
    tldict, rev_tldict = np.load(os.path.join(destination, 'all_dicts.npy'))
...
if __name__=='__main__':
    ...
    validation_users = np.load('data/iitk-dataset/validation_users.npy').item()
    bins 			 = np.load('data/iitk-dataset/bins.npy')
