...
# results = eval(open('./result_repository/result_repository/result_DataSet_tegcer_FastText/result.txt', mode='r').read())
#
...
#             data['program_id'] == result[0], 'in_predict_top3'
#         ] = 'No'
# data.to_excel('./result_repository/result_repository/result_DataSet_tegcer_FastText/test_predict.xlsx', index=False)
#
# #----------------------------------------------------------------------------------------------------------------#
# #                                             结果分析
# #----------------------------------------------------------------------------------------------------------------#
...
# statistics_frame.to_excel('./result_repository/result_repository/result_DataSet_tegcer_FastText/analysis_of_test.xlsx', index=False)
